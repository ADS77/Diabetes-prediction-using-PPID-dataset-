...
from preprocessing import *  ### Import all userfunction from utils.py
...
X = dataset.iloc[:, [1,0,2,3,5,6,7]].values #select SEX,BMI,AGE,CURSMOKE #,3,6
...
# ROC curve
from sklearn.metrics import roc_curve, roc_auc_score
print('roc_auc_score: ', roc_auc_score(yTrain, y_pred))
...
yTestPredictProbability = model.predict(xTrain)
FPR, TPR, _ = roc_curve(yTest, yTestPredictProbability)
